...
class APITestCase(unittest.TestCase):
    ...
    def test_api_nominal_evaluations(self):
        ...
        self.assertEqual(np.round(deterministic_analysis_results.nominal_intermediate_variables['r_ratio'], decimals=2), 0.11)
        self.assertEqual(np.round(deterministic_analysis_results.nominal_intermediate_variables['%SMYS'], decimals=2), 30.85)
    ...
    def test_save_deterministic_results(self):
        ...
        self.assert_is_file(self.folder_path+'Nominal_Results.csv')
    ...
    def test_generating_intermediate_variables(self):
        ...
        self.assertEqual(len(self.deterministic_results.nominal_intermediate_variables['%SMYS']), 1)
        self.assertFalse(self.deterministic_results.sampling_intermediate_variables)
        self.assertEqual(len(self.probabilistic_results.nominal_intermediate_variables['%SMYS']), 1)
